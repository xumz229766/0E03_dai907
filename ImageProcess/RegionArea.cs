...
{
   public class RegionArea : IProcess
    {
       ...
       // public bool bAngleTest = true;//角度检测，否则为面积检测
        ...
        public RegionArea(string _name)
        {
            Name = _name;
        ...
        public override void action(HalconDotNet.HObject hImage)
        {
            ...
            //如果Ok为1，NG为0
            if(bTestResult)
                addOutputResult(OutputResult.RArea_Result, 1);
            else
                addOutputResult(OutputResult.RArea_Result, 0);
        }
        ...
        public override void initParam(string strFile)
        {
            ...
            iMinThreshold = Convert.ToInt32(IniOperate.INIGetStringValue(strFile, strSection, "MinThreshold", "0"));
            iMaxThreshold = Convert.ToInt32(IniOperate.INIGetStringValue(strFile, strSection, "MaxThreshold", "100"));
